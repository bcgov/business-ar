...
<template>
  <client-only>
    <div v-show="!pageLoading" class="mx-auto flex flex-col items-center justify-center gap-4 text-center sm:w-4/5 xl:w-3/5">
      ...
      <SbcNuxtContentCard v-show="submittedSuccessText && Object.keys(submittedSuccessText).length > 0" id="submitted-success-text" route-suffix="/success-text" :content="submittedSuccessText" />
